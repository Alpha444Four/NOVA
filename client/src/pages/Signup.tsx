    ...
    <PageTransition>
      <div className="mx-auto flex min-h-[70vh] max-w-md flex-col justify-center px-4 py-12">
        ...
        >
          ...
          <p className="mt-1 text-sm text-[var(--color-nova-muted)]">Join NOVA for faster checkout and order tracking</p>
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            <label className="block text-sm font-medium">
              Name
              <input name="name" required className="mt-1 w-full rounded-xl border border-[var(--color-nova-border)] bg-transparent px-3 py-2" />
            </label>
            <label className="block text-sm font-medium">
              Email
          ...
          <p className="mt-4 text-center text-sm text-[var(--color-nova-muted)]">
            Already have an account? <Link to="/login" className="font-semibold text-nova-primary">Log in</Link>
          </p>
        </motion.div>
      </div>
    </PageTransition>
